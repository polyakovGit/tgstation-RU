...
/datum/action/cooldown/mob_cooldown/charge/triple_charge/ravager
	...
	charge_damage = 25
	button_icon = 'tgru_modular/modules/tgmc_xenos/icons/xeno_actions.dmi'
...
/datum/action/cooldown/mob_cooldown/charge/triple_charge/ravager/do_charge_indicator(atom/charger, atom/charge_target)
	playsound(charger, 'tgru_modular/modules/tgmc_xenos/sound/alien_roar2.ogg', 100, TRUE, 8, 0.9)
...
/datum/action/cooldown/spell/aoe/repulse/xeno/tgmc_tailsweep/slicing
	...
	sound = 'tgru_modular/modules/tgmc_xenos/sound/alien_tail_swipe.ogg' //The defender's tail sound isn't changed because its big and heavy, this isn't

	impact_sound = 'modular_tgru/master_files/sound/weapons/bloodyslice.ogg'
	impact_damage = 40
	impact_sharpness = SHARP_EDGED

/obj/effect/temp_visual/dir_setting/tailsweep/ravager
	icon = 'tgru_modular/modules/tgmc_xenos/icons/xeno_actions.dmi'
...
/datum/action/cooldown/alien/tgmc/literally_too_angry_to_die/Activate()
	...
	playsound(owner, 'tgru_modular/modules/tgmc_xenos/sound/alien_roar1.ogg', 100, TRUE, 8, 0.9)
