...
/datum/action/cooldown/alien/tgmc/warrior_agility/proc/begin_agility()
	...
	playsound(agility_target, 'tgru_modular/modules/tgmc_xenos/sound/alien_hiss.ogg', 100, TRUE, 8, 0.9)
...
/datum/action/cooldown/alien/tgmc/warrior_agility/proc/end_agility()
	...
	playsound(agility_target, 'tgru_modular/modules/tgmc_xenos/sound/alien_roar2.ogg', 100, TRUE, 8, 0.9) //Warrior runs up on all fours, stands upright, screams at you
