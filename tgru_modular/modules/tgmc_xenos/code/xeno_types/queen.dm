...
/datum/action/cooldown/alien/tgmc/queen_screech/Activate()
	...
	playsound(queenie, 'tgru_modular/modules/tgmc_xenos/sound/alien_queen_screech.ogg', 100, FALSE, 8, 0.9)
...
/mob/living/carbon/alien/adult/tgmc/proc/create_shriekwave()
	...
	overlays_standing[HALO_LAYER] = image("icon" = 'tgru_modular/modules/tgmc_xenos/icons/big_xenos.dmi', "icon_state" = "shriek_waves") //Ehh, suit layer's not being used.
